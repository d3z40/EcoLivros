...
<body>
  ...
  <div class="main-content">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-13 col-md-12">
            <h1 class="display-2 text-white">Cupons</h1>
            <p class="text-white mt-0 mb-5">Essa é a consulta de cupons. Você poderá consultar as informações dos cupons.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid mt--9">
	  ...
	  %>
      <form action="SalvarCupom" method="POST" class="form-horizontal">
          <div class="row">
	        <div class="col-xl-12 order-xl-5">
	          <div class="card shadow">
	            ...
	            <div class="table-responsive">
	              <table id="tblCupom" class="table align-items-center table-flush">
		            <thead class="thead-light">
		              <tr>
		                <th scope="col">Identificador</th>
		                <th scope="col">Valor Cupom</th>
	                		...
	                		<td scope="row">
			                  <div class="media align-items-center">
			                    <div class="media-body">
			                      <span class="mb-0 text-sm"><b><%=cupom.getIdentificador() %></b></span>
			                    </div>
			                  </div>
			                </td>
			                <td>
			                  <%out.print(String.format("R$ %,6.2f", cupom.getValorCupom())); %>
			                </td>
			                <td>
			                  <%out.print(String.format("R$ %,6.2f", cupom.getValorUtilizado())); %>
			                </td>
			                <td>
			                  <%out.print(String.format("R$ %,6.2f", (cupom.getValorCupom() - cupom.getValorUtilizado()))); %>
			                </td>
			              </tr>
		            	<%
			            		}
