      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-13 col-md-12">
            ...
            <p class="text-white mt-0 mb-5">Essa é a consulta de endereços. Você poderá consultar, deletar e selecionar para alterar as informações de um endereço.</p>
          </div>
        </div>
      </div>
    </div>
	        ...
	        <div class="col-xl-12 order-xl-5">
	          <div class="card shadow">
	            ...
	            <div class="table-responsive">
	              <table id="tblEndereco" class="table align-items-center table-flush">
	                		...
	                		<td scope="row">
			                  <div class="media align-items-center">
			                    <div class="media-body">
			                      <span class="mb-0 text-sm"><b><%=end.getDescricao() %></b></span>
			                    </div>
			                  </div>
			                </td>
			                <td>
			                ...
			                <td class="text-center">
			                  <div class="dropdown">
			                    ...
			                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
			                      <a class="dropdown-item" href="SalvarEndereco?operacao=CONSULTAR&IdEndereco=<%=end.getId() %>"><i class="ni ni-ruler-pencil text-blue"></i> Alterar</a>
			                      <a class="dropdown-item" href="SalvarEndereco?operacao=EXCLUIR&IdEndereco=<%=end.getId() %>"><i class="ni ni-button-power text-red"></i> Excluir</a>
			                   </div>
			                  </div>
			                </td>
			              </tr>
