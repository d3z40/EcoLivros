...
<%@page import="br.com.ecolivros.enuns.TipoRelatorio"%>
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Relatórios</a>
        <!-- User -->
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-13 col-md-12">
            <h1 class="display-2 text-white">Relatórios</h1>
            <p class="text-white mt-0 mb-5">Esses são os relatórios do EcoLivros. Vocé poderá efetuar algumas análises sob suas vendas.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid mt--9">
      <form action="SalvarRelatorio" method="post" class="form-horizontal">
	      <div class="row">
	            ...
	            <div class="card-header border-4">
	              <div class="row">
	                ...
	                <div class="row">
					  ...
					  <div class="col-lg-4">
						<div align="center" class="form-group">
						  <label class="form-control-label" for="txtTipoRelatorio">Tipo Relatório</label>
	        ...
	        <div class="col-xl-12 order-xl-5">
	          <div class="card shadow">
	            <img style="width: 100%" class="img-responsive" src="images/GraficoLinha_Qtde.jpeg">
	            <img style="width: 100%" class="img-responsive" src="images/GraficoLinha_Valor.jpeg">
	            <img style="width: 100%" class="img-responsive" src="images/GraficoBarra_Qtde.jpeg">
	            <img style="width: 100%" class="img-responsive" src="images/GraficoBarra_Valor.jpeg">
	          </div>
	        </div>
	        <%
				}
