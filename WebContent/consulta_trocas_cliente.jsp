...
<body>
  ...
  <div class="main-content">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-13 col-md-12">
            ...
            <p class="text-white mt-0 mb-5">Essa é a consulta de trocas. Você poderá consultar as informações das trocas.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid mt--9">
      <%
 	  	List<EntidadeDominio> trocas = (List<EntidadeDominio>) request.getAttribute("trocas");
	  %>
	        ...
	        <div class="col-xl-12 order-xl-5">
	          <div class="card shadow">
	            ...
	            <div class="table-responsive">
	              <table id="tblTroca" class="table align-items-center table-flush">
		            <thead class="thead-light">
		              ...
		              <tbody>
		            	<%
		            		if (trocas != null) {
			            		for (EntidadeDominio ed : trocas) {
			            			Troca troca = (Troca) ed;
		            	%>
		            	  <tr>
	                		<td scope="row">
			                  <div class="media align-items-center">
			                    <div class="media-body">
			                      <span class="mb-0 text-sm"><b><%=troca.getNumeroPedido() %></b></span>
			                    </div>
			                  </div>
			                </td>
			                <td>
			                ...
			                <td>
			                  <%=troca.getSituacaoItem().getDescricao() %>
			                </td>
			              </tr>
		            	<%
			            		}
