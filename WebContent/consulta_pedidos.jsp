      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-13 col-md-12">
            ...
            <p class="text-white mt-0 mb-5">Esse é a consulta de pedidos. Vocé poderá consultar e detalhar as informações de um pedido.</p>
          </div>
        </div>
      </div>
    </div>
		            	...
		            	<%
		            		if (pedidos != null) {
			            		for (EntidadeDominio ed : pedidos) {
			            			Pedido pedido = (Pedido) ed;
			            			Calendar dataCadastro = Calendar.getInstance();
			            			dataCadastro.setTime(pedido.getDtCadastro());
		            	%>
		            	  <tr>
	                		<td scope="row">
			                  <div class="media align-items-center">
			                    <div class="media-body">
			                      <span class="mb-0 text-sm"><b><%=pedido.getNumPedido() %></b></span>
			                    </div>
			                  </div>
			                </td>
			                <td>
			                  <%=String.format("%02d/%02d/%04d", dataCadastro.get(Calendar.DAY_OF_MONTH), dataCadastro.get(Calendar.MONTH), dataCadastro.get(Calendar.YEAR)) %>
			                </td>
			                <td>
			                  <%=String.format("R$ %,6.2f", pedido.getTotal()) %>
			                </td>
			                <td class="text-center">
			                  <div class="dropdown">
			                    ...
			                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
			                      <a class="dropdown-item" href="SalvarPedido?operacao=CONSULTAR&IdPedido=<%=pedido.getId() %>"><i class="ni ni-ruler-pencil text-blue"></i> Consultar</a>
			                    </div>
			                  </div>
			                </td>
			              </tr>
