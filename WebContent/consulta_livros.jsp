...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Consulta de Livros</a>
        <!-- User -->
		            		...
		            		if (livros != null) {
			            		for (EntidadeDominio ed : livros) {
			        				...
			        				for (Autor autor : livro.getAutores()) {
			        					if (isSecondOrMore)
			        						autores.append("/");
			        					autores.append(autor.getNomeArtistico());
	                		...
	                		<td scope="row">
			                  <div class="media align-items-center">
			                    <div class="media-body">
			                      <span class="mb-0 text-sm"><b><%=livro.getTitulo() %></b></span>
			                    </div>
			                  </div>
			                </td>
			                <td>
			                  <%=livro.getEditora().getRazao() %>
			                </td>
			                <td>
			                  <%=autores.toString() %>
			                </td>
			                <td>
			                  <%if(livro.isAtivo()) out.print("Sim"); else out.print("Não");%>
			                </td>
			                <td>
			                  <%=livro.getISBN() %>
			                </td>
			                <td class="text-center">
			                  <div class="dropdown">
			                    ...
			                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
			                      <a class="dropdown-item" href="SalvarLivro?operacao=CONSULTAR&IdLivro=<%=livro.getId() %>"><i class="ni ni-ruler-pencil text-blue"></i> Alterar</a>
			                      <a class="dropdown-item" href="SalvarLivro?operacao=EXCLUIR&IdLivro=<%=livro.getId() %>"><i class="ni ni-button-power text-red"></i> Excluir</a>
			                    </div>
			                  </div>
			                </td>
			              </tr>
