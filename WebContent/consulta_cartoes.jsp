...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <%
          ...
          CartaoDeCredito cartaoDeCredito = (CartaoDeCredito) request.getAttribute("cartao");
        %>
        <ul class="navbar-nav">
          <li class="nav-item">
  ...
  <div class="main-content">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-13 col-md-12">
            <h1 class="display-2 text-white">Cartões</h1>
            <p class="text-white mt-0 mb-5">Essa é a consulta de cartões. Você poderá consultar, deletar e selecionar para alterar as informações de um cartão.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid mt--9">
      <%
 	  	List<EntidadeDominio> cartoes = (List<EntidadeDominio>) request.getAttribute("cartoes");
	  %>
      <form action="SalvarCartaoDeCredito" method="POST" class="form-horizontal">
          <div class="row">
	        <div class="col-xl-12 order-xl-5">
	          <div class="card shadow">
	            ...
	            <div class="table-responsive">
	              <table id="tblCartaoDeCredito" class="table align-items-center table-flush">
		            <thead class="thead-light">
		              <tr>
		                <th scope="col">Nome no Cartão</th>
		                <th scope="col">Nº do Cartão</th>
		            	...
		            	<%
		            		if (cartoes != null) {
			            		for (EntidadeDominio ed : cartoes) {
			            			CartaoDeCredito cartao = (CartaoDeCredito) ed;
		            	%>
		            	  <tr>
	                		<td scope="row">
			                  <div class="media align-items-center">
			                    <div class="media-body">
			                      <span class="mb-0 text-sm"><b><%=cartao.getNomeNoCartao() %></b></span>
			                    </div>
			                  </div>
			                </td>
			                <td>
			                ...
			                <td>
			                  <%=cartao.getMesValidade() + "/" + cartao.getAnoValidade() %>
			                </td>
			                <td>
			                  <%=cartao.getBandeira().getDescricao() %>
			                </td>
			                <td class="text-center">
			                  <div class="dropdown">
			                    ...
			                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
			                      <a class="dropdown-item" href="SalvarCartaoDeCredito?operacao=CONSULTAR&IdCartaoDeCredito=<%=cartao.getId() %>"><i class="ni ni-ruler-pencil text-blue"></i> Alterar</a>
			                      <a class="dropdown-item" href="SalvarCartaoDeCredito?operacao=EXCLUIR&IdCartaoDeCredito=<%=cartao.getId() %>"><i class="ni ni-button-power text-red"></i> Excluir</a>
			                   </div>
			                  </div>
			                </td>
			              </tr>
