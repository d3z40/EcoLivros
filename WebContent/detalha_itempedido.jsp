...
<body>
  ...
  <div class="main-content">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-13 col-md-12">
            <h1 class="display-2 text-white">Item Pedido</h1>
            <p class="text-white mt-0 mb-5">Esse é a consulta detalhada de um item de um pedido. Vocé poderá selecionar para efetuar a troca.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid mt--9">
      <%
 	  	List<ItemPedido> itensPedidos = (List<ItemPedido>) request.getAttribute("itensPedidos");
	  %>
      <form action="SalvarItensPedido" method="POST" class="form-horizontal">
          <div class="row">
		            	...
		            	<%
		            		if (itensPedidos != null) {
			            		for (ItemPedido itemPedido : itensPedidos) {
			            			String tituloLivro = new LivroDAO().getTitulo(itemPedido.getIdLivro());
		            	%>
		            	  <tr>
	                		<td>
	                		  <%=tituloLivro %>
			                ...
			                <td>
			                  <%=String.format("R$ %,6.2f", itemPedido.getValor()) %>
			                </td>
			                <td>
			                  <%=itemPedido.getSituacaoItem().getDescricao() %>
			                </td>
			                <td class="text-center">
			                  <div class="dropdown">
			                    ...
			                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
			                      <a class="dropdown-item" href="SalvarItemPedido?operacao=ALTERAR&IdItemPedido=<%=itemPedido.getId() %>"><i class="ni ni-ruler-pencil text-blue"></i> Trocar</a>
			                    </div>
			                  </div>
			                </td>
			              </tr>
