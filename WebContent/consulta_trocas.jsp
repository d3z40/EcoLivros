      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-13 col-md-12">
            ...
            <p class="text-white mt-0 mb-5">Esse é a consulta de trocas. Vocé poderá consultar, liberar ou não aceitar as trocas.</p>
          </div>
        </div>
      </div>
    </div>
		            	...
		            	%>
		            	  <tr>
			                ...
			                <td class="text-center">
			                  <input type="radio" id="radAprovacao^<%=i %>" name="radAprovacao^<%=i %>" value="0"> Não
