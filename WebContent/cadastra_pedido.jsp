      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-13 col-md-12">
            ...
            <p class="text-white mt-0 mb-5">Esse é o cadastro de pedido. Vocé poderá efetuar um pedido.</p>
          </div>
        </div>
      </div>
    </div>
					  ...
					  <div class="row">
						<div class="col-lg-6">
						  <div class="form-group">
							...
							<input readonly type="text" id="txtNumPedido" name="txtNumPedido" value="" class="form-control form-control-alternative" placeholder="Nº Pedido">
						  </div>
						</div>
					  </div>
				  	</div>
